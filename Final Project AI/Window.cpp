...
bool Window::Init(char* _windowName, int _windowX, int _windowY)
{
	...
	gWindow = SDL_CreateWindow(_windowName, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_UNDEFINED, _windowX, _windowY, SDL_WINDOW_OPENGL);
	...
	glLoadIdentity();
	gluPerspective(45.0f, _windowX / _windowY, 1.0f, 1000.0f);
